...
3. Reasoning loop -- build understanding:
   ...
   CONVERGENCE TEST:
   Periodically -- when you sense the understanding might be
   sufficient -- attempt to express each key understanding.md entry
   as a behavioral intent: "When [trigger], [observable outcome]."
